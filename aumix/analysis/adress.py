...
def _null2peak_stereo(fas, lfk, rfk, beta):
...
def adress_stereo_null_peak_at_sec(tau,
                                 t,
                                 *args,
                                 **kwargs):
    """
    ...
    return adress_stereo_null_peak_at_idx(tau_idx=tau_idx,
                                        *args,
                                        **kwargs)
